...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CmgeOverseaSDK/CmgeCore/CmgeStandardKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CmgeOverseaSDK/CmgeCore/CmgeIdentifierKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CmgeOverseaSDK/CmgeCore/CmgeShareKit.framework"
